...
Example: python scripts/discord_notify.py v1.0.2 https://github.com/Osiris-RK/extended-afk/releases/tag/v1.0.2
"""
...
def create_embed(version: str, release_url: str) -> dict:
    ...
    embed = {
        "title": f"Extended AFK {version}",
        "description": "\n".join(description_parts),
        "color": 0xC9A961,  # Gold/accent color matching app theme
        "url": release_url,
        "footer": {
            "text": "Extended AFK"
        },
        "thumbnail": {
            "url": "https://raw.githubusercontent.com/Osiris-RK/extended-afk/main/assets/osiris-devworks.png"
        }
    }
...
def send_discord_notification(version: str, release_url: str) -> bool:
    ...
    payload = {
        "content": "@everyone",
        "embeds": [embed],
        "username": "Extended AFK Releases",
        "allowed_mentions": {
            "parse": ["everyone"]
        }
    }
    ...
    try:
        req = urllib.request.Request(
            ...
            headers={
                ...
                'User-Agent': 'Extended-AFK-Release-Bot/1.0'
            }
        )
...
def main():
    if len(sys.argv) != 3:
        ...
        print("Example: python scripts/discord_notify.py v1.0.2 https://github.com/Osiris-RK/extended-afk/releases/tag/v1.0.2")
        sys.exit(1)
